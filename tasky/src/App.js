...
function App() {
  const [taskState, setTaskState] = useState({
    tasks : [
      ...
      { id:4, title: "Hoover", description: "Hoover the rooms with carpet", deadline: "Today" },
      { id:5, title: "Polish", description: "Polish all tables and kitchen surfaces", deadline: "Tomorrow" }
